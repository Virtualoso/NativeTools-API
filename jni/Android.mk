...
LOCAL_MODULE    := com.virtualoso.addon.exampletabs # should match the name in the AndroidManifest.xml
...
LOCAL_LDLIBS    := -L$(LOCAL_PATH) -llog -ldl -lminecraftpe -lmcpelauncher_tinysubstrate -lcom.virtualoso.addon.nativetools
